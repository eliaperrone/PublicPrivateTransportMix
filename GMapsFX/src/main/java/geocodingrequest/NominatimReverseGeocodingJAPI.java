...
public class NominatimReverseGeocodingJAPI {
	private static final String NominatimInstance = "https://nominatim.openstreetmap.org";
	...
	public static Address getAdress(double lat, double lon){
		Address result = null;		
